...
def pararel(data_path: str = "datasets/pararel.json"):
    ...
    #             f"https://github.com/yanaiela/pararel/tree/main/data/pattern_data/graphs_json/{r}.jsonl"
    #         ) as url:
    #             graphs = [
    ...
    #         with urllib.request.urlopen(
    #             f"https://github.com/yanaiela/pararel/tree/main/data/trex_lms_vocab/{r}.jsonl"
    #         ) as url:
    #             vocab = [
    #                 json.loads(d.strip()) for d in url.read().decode().split("\n") if d
    #             ]
    ...
    #     return PARAREL
        ...
        for r in tqdm(PARAREL_RELATION_NAMES, "loading local data"):
            with open(f"/home/chenyuheng/chenyuheng/Knowledge-representation/m-kn/pararel_data/pattern_data/graphs_json/{r}.jsonl", "r") as f:
                graphs = [json.loads(line.strip()) for line in f if line.strip()]
                PARAREL[r]["graphs"] = graphs
            with open(f"/home/chenyuheng/chenyuheng/Knowledge-representation/m-kn/pararel_data/trex_lms_vocab/{r}.jsonl", "r") as f:
